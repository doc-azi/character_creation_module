...
def attack(char_name: str, char_class: str) -> str:
    """Calculate the amount of damage done for each class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate the damage blocked for each class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Calculate the special talent for each class."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Welcome world for each class and request for training."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Chose of the class with each one characteristic."""
    ...
    while approve_choice != 'y':
        ...
        approve_message = ('Нажми (Y), чтобы подтвердить выбор,'
                           'или любую другую кнопку,'
                           'чтобы выбрать другого персонажа: ')
        approve_choice = input(approve_message).lower()
    return char_class
